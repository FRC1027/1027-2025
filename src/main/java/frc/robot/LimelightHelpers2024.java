...
public class LimelightHelpers2024 {
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName) {
        var poseEntry = LimelightHelpers2024.getLimelightNTTableEntry(limelightName, entryName);
    ...
    public static LimelightResults getLatestResults(String limelightName) {
        ...
        LimelightHelpers2024.LimelightResults results = new LimelightHelpers2024.LimelightResults();
        if (mapper == null) {
