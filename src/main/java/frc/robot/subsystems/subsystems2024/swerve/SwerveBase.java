...
import frc.robot.Robot2024Container;
...
public class SwerveBase extends SubsystemBase {
    ...
    public PhotonCameraWrapper cam = new PhotonCameraWrapper(Constants2024.CameraConstants.CAMERA_NAME,
            Constants2024.CameraConstants.KCAMERA_TO_ROBOT.inverse());
...
//    private Rotation2d fieldOffset = new Rotation2d(gyro.getYaw()).rotateBy(new Rotation2d(180));
    ...
    private GenericEntry aprilTagTarget = Robot2024Container.autoTab
    ...
    public SwerveBase() {
        ...
        swerveMods = new RevSwerveModule[] {
            ...
            new RevSwerveModule(0, Constants2024.Swerve.Modules.Mod0.constants),
            new RevSwerveModule(1, Constants2024.Swerve.Modules.Mod1.constants),
            new RevSwerveModule(2, Constants2024.Swerve.Modules.Mod2.constants),
            new RevSwerveModule(3, Constants2024.Swerve.Modules.Mod3.constants)
        };

        swerveOdometer = new SwerveDrivePoseEstimator(Constants2024.Swerve.swerveKinematics, getYaw(), getModulePositions(), new Pose2d());
        zeroGyro();
  ...
  //      SmartDashboard.putNumber("wheelin Counter",wheelinCounter++);
    ...
    public void drive(Translation2d translation, double rotation, boolean fieldRelative, boolean isOpenLoop) {
       ...
       true ?
        ...
        SwerveModuleState[] swerveModuleStates = Constants2024.Swerve.swerveKinematics.toSwerveModuleStates(desiredChassisSpeeds);
        SwerveDriveKinematics.desaturateWheelSpeeds(swerveModuleStates, Constants2024.Swerve.maxSpeed);
...
//        SmartDashboard.putNumber("wheel 4",state.angle.getDegrees());
        for(RevSwerveModule mod : swerveMods){
            ...
            mod.setPosition(setAngle * Constants2024.Swerve.turnRatio);
        } 
    }
    ...
    public void setModuleStates(SwerveModuleState[] desiredStates) 
    {
     //   SmartDashboard.putNumber("setDesireStatess",setDesireCounters++);
       // System.out.println("setting module states: "+desiredStates[0]);
        SwerveDriveKinematics.desaturateWheelSpeeds(desiredStates, Constants2024.Swerve.maxSpeed);
    ...
    public Rotation2d getYaw() {
        return (Constants2024.Swerve.invertGyro) ? Rotation2d.fromDegrees(360).minus(gyro.getRotation2d()) : gyro.getRotation2d();
    }
